...
print(floorSize_field_area.getSFVec2f())

lenght_area = floorSize_field_area.getSFVec2f()[0]
print(translation_field.getSFVec3f()[0]/lenght_area)
print(translation_field.getSFVec3f()[1]/lenght_area)
...
with open("position_indicator.txt", "r") as fileData:
