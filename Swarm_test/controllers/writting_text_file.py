...
path_dir = r"d:\Dossiers locaux\Bureau\Scolaire\ESIREM 2021-20XX\3ème semestre\stage\Stage_subject\Webots_project\Swarm_test\controllers\ship_swarm_quantumGate_instant"
...
def main ():
    ...
    name_variable_file = "\static_varriables.txt"
